...
function DesktopAppContainer({
  ...
  return (
    <div style={{
      ...
      transform: `scale(${Math.min(window.innerWidth / 1440, window.innerHeight / 900, 1)}) translate(-50%, -50%)`
    }}>
              ...
              <div className="sidebar-content">
                ...
                <div className="nav-buttons">
                  ...
                  >
                    ...
                    <span className="nav-button-text">What If...?</span>
                  </button>
                  <button 
                  ...
                  >
                    ...
                    <span className="nav-button-text">Draw It<br />Out</span>
                  </button>
                  <button 
